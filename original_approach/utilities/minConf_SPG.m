...
[verbose,numDiff,optRelTol,progTol,maxIter,suffDec,interp,memory,useSpectral,curvilinear,feasibleInit,testOpt,bbType] = ...
   myProcessOptions(...
   options,'verbose',2,'numDiff',0,'optRelTol',1e-5,'progTol',1e-9,'maxIter',500,'suffDec',1e-4,...
...
%optTol = max(optAbsTol,optRelTol*max(abs(funProj(x-g)-x)));
optTol = optRelTol;
